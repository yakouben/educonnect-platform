...
export function Sidebar({ activeSection, setActiveSection }: SidebarProps) {
  return (
    <div className="fixed left-0 top-0 h-screen w-64 xl:w-72 bg-gradient-to-b from-purple-600 to-purple-800 text-white flex flex-col z-40 shadow-2xl">
      {/* Logo */}
      <div className="p-6 xl:p-8 border-b border-purple-500/30">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-purple-200 text-sm xl:text-base">Learning Platform</p>
          </div>
        </div>
      </div>
      ...
      {/* Bottom Actions */}
      <div className="p-6 xl:p-8 border-t border-purple-500/30 space-y-2">
        <button className="w-full flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-white/10 text-purple-100 hover:text-white transition-all duration-200 group">
